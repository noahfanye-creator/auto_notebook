...
def create_pdf_with_market_analysis(stock_code: str, stock_name: str, stock_data_map: Dict[str, Any], 
                                    indices_data: Dict[str, Any], save_path: str, temp_dir: str) -> bool:
